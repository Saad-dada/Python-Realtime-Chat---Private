...
from .functions import upload_to_imgbb
...
def register():
    if request.method == 'POST':
        ...
        if user:
            ...
            new_user = User(username=username, nickname=username, email=email, password=generate_password_hash(password, method='pbkdf2:sha256'), dob=dob, gender=gender, country=country)
